"""Unitree Go1 velocity-tracking locomotion, as a standalone copy of IsaacLab's task.
...
FLAT_ENV_ID = "IL4OP-Velocity-Flat-Unitree-Go1-v0"
ROUGH_ENV_ID = "IL4OP-Velocity-Rough-Unitree-Go1-v0"
