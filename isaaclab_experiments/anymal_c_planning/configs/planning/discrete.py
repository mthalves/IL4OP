...
class OnlinePlanning(ManagerTermBase):
    ...
    available_problems = {
        'inspection.discrete': 'DiscreteInspectionProblem',
    }
    ...
    def get_problem(self, env, problem_name, args):
        if problem_name is None:
            ...
            self.problem_name = 'inspection.discrete'
        else:
    ...
    def import_problem(self,problem_name):
        ...
        try:
            ...
            print('Loading default planning method: inspection.discrete')
            method = getattr(module, self.available_problems['inspection.discrete'])
        return method
