...
from isaaclab_experiments.go1_locomotion_contact_consistency.cnet import GO1_FEET as CNET_FEET
from isaaclab_experiments.go1_locomotion_contact_consistency.velocity_env_cfg import (
